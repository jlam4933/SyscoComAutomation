...
public class SyscoComWebpagesTests_51_100
{
    ...
    public void testLoadTheUrlsOfWebpageAndtakingTheFullScreenShotImage() throws URISyntaxException {
        for (int rownum = 51; rownum <= 100; rownum++) {
            ...
            Shutterbug.shootPage(driver, Capture.FULL, 500, true).withName(rownum + shorturl).save("src/main/resources/Fullpagescreenshotof_Syscocom_Webpages_51_100");
        }
    }
    @AfterMethod
