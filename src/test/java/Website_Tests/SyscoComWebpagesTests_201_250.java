...
public class SyscoComWebpagesTests_201_250
{
    ...
    @Test
    public void testLoadTheUrlsOfWebpageAndtakingTheFullScreenShotImage()  {
        for (int rownum = 200; rownum <= rowCount; rownum++) {
            ...
            Shutterbug.shootPage(driver, Capture.FULL, 500, true).withName(rownum + shorturl).save("src/main/resources/Fullpagescreenshotof_Syscocom_Webpages_201_250");
        }
    }
    @AfterMethod
