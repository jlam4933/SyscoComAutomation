...
public class SyscoComWebpagesTests_1_50 {
    ...
    public void testLoadTheUrlsOfWebpageAndtakingTheFullScreenShotImage()  {
        ...
        for (int rownum = 2; rownum <= 50; rownum++) {
            ...
            Shutterbug.shootPage(driver, Capture.FULL, 500, true).withName(rownum + shorturl).save("src/main/resources/Fullpagescreenshotof_Syscocom_Webpages_1_50");
