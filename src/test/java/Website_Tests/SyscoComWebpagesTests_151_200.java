...
public class SyscoComWebpagesTests_151_200
{
    ...
    public void testLoadTheUrlsOfWebpageAndtakingTheFullScreenShotImage() throws URISyntaxException {
        for (int rownum = 151; rownum <= 200; rownum++) {
            ...
            Shutterbug.shootPage(driver, Capture.FULL, 500, true).withName(rownum + shorturl).save("src/main/resources/Fullpagescreenshotof_Syscocom_Webpages_151_200");
        }
    }
    @AfterMethod
